...
from .pyvesync_helpers import Helpers, Timer
...
class VeSyncAirBypass(VeSyncBaseDevice):
    ...
    def get_timer(self) -> Optional[Timer]:
        ...
        See Also:
            [pyvesync_helpers.Time][`Timer`] : Timer object used to hold status of timer
...
air_features: dict = {
    ...
    'Vital100S': VeSyncAirBaseV2,
    'Vital200S': VeSyncAirBaseV2,
    'EverestAir': VeSyncAirBaseV2,
    'SmartTowerFan': VeSyncTowerFan,
}
