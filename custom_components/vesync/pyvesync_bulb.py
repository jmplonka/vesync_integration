...
from .pyvesync_helpers import Helpers as helpers, Color
...
class VeSyncBulb(VeSyncBaseDevice):
    ...
    [`VeSyncBaseDevice`][pyvesync_basedevice.VeSyncBaseDevice]. This class
    ...
    Attributes:
        ...
        color (Color): Color of bulb in the form of a dataclass with two namedtuple
            attributes - `hsv` & `rgb`. See [pyvesync_helpers.Color][].
    """
    ...
    def color_hsv(self) -> NamedTuple | None:
        """Return color of bulb as [hsv named tuple][pyvesync_helpers.HSV].
    ...
    def color_rgb(self) -> NamedTuple | None:
        """Return color of bulb as [rgb named tuple][pyvesync_helpers.RGB].
    ...
    def color_mode(self) -> str | None:
        ...
        Notes:
            ...
            the [`feature_dict`][pyvesync_bulb.feature_dict].
        """
...
class VeSyncBulbESL100MC(VeSyncBulb):
    ...
    Inherits from [VeSyncBulb][pyvesync_bulb.VeSyncBulb]
    and [VeSyncBaseDevice][pyvesync_basedevice.VeSyncBaseDevice].
    ...
    Attributes:
        ...
        color (Color): Color of bulb in the form of a dataclass with
            two named tuple attributes - `hsv` & `rgb`. See [pyvesync_helpers.Color][].
    ...
    Notes:
        ...
        ```
        See pyvesync_helpers.Color for more information on the Color dataclass.
    """
...
class VeSyncBulbESL100(VeSyncBulb):
    ...
    This bulb only has the dimmable feature. Inherits from pyvesync_bulb.VeSyncBulb
    and pyvesync_basedevice.VeSyncBaseDevice.
...
bulb_modules: dict = {
    ...
    'XYD0001': VeSyncBulbValcenoA19MC,
