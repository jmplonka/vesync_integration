...
Note:
    ...
    `vesync.object_factory` during initial call to pyvesync.update() and
...
from .pyvesync_helpers import Helpers as helpers
...
class VeSyncSwitch(VeSyncBaseDevice):
    ...
    pyvesync_basedevice.VeSyncBaseDevice. Should not be instantiated directly,
